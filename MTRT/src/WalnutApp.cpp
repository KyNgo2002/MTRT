...
public:
		...
		: m_Camera(45.0f, 0.1f, 100.0f)
	{
		...
		Material& Surface = m_Scene.Materials.emplace_back();
		Surface.Color = { 0.835f, 0.835f, 0.87f };
		Surface.Roughness = 0.02f;

		Material& OrangeSphere = m_Scene.Materials.emplace_back();
		OrangeSphere.Color = { 0.8f, 0.5f, 0.2f };
		OrangeSphere.Roughness = 0.0f;
		OrangeSphere.EmissionColor = OrangeSphere.Color;
	...
	virtual void OnUIRender() override
	{
		...
		ImGui::Checkbox("Render Sky", &m_Renderer.GetSettings().RenderSky);
		...
		for (size_t i = 0; i < m_Scene.Materials.size(); i++)
		{
			...
			ImGui::ColorEdit3("Albedo", glm::value_ptr(material.Color));
...
Walnut::Application* Walnut::CreateApplication(int argc, char** argv)
{
	...
	spec.Name = "Multithreaded Raytracer";
